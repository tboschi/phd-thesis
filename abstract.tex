...
In \refcha{cha:mass_models} a possible Standard Model extension to explain neutrino masses is considered, %
and the phenomenology of such models is extensively studied in the context of a beam dump experiment.
The prospect of the DUNE's near detector to searches of heavy neutral lepton decays is then evaluated in \refcha{cha:hnl_dune}.
It is found that the DUNE ND is capable of extending current limits on these searches, %
