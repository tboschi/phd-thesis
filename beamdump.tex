...
The Near Detector of DUNE is described in \refsec{sec:dunend} and its simulation in \refsec{sec:experiment}.
...
With the help of a Monte Carlo simulation, the $D_s^+$ four-momenta are generated starting from~\refeq{eq:dsflux} %
...
In this section, the sensitivity regions for the discovery of heavy neutrino decays are presetned %
...
Instead of dealing with a three-dimensional parameter scan, the study is simplified %
...
The decay into a pseudoscalar meson is the channel with the highest branching ratio (see \refsec{sec:decay}) %
...
Thanks to the different anular dependency of polarised decay rates for Majorana and Dirac, analysing the angular distributions of %
HNL decays could be in principle used to distinguish between the two scenarios.
As studied in~\refsec{sec:pseudoscalar}, the two-body decay distributions for a Majorana neutrino %
...
In~\reffig{fig:cutback}, we show the difference between simulated signal events from a Majorana and Dirac neutrino %
...
It is worth noting, that aside from the neutral current distributional differences discussed in~\refref{Balantekin:2018ukw}, %
