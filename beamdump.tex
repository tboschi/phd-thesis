...
The ND is described in \refsec{sec:dunend} and its simulation in \refsec{sec:experiment}.
...
\begin{figure}[t]
	...
	\caption[Sensitivity regions to individual channels for dominant mixings without bakground analysis]%
		{The 90\,\% C.L. sensitivity regions to individual channels for dominant mixings %
...
The decay into a pseudo-scalar meson is the channel with the highest branching ratio (see \refsec{sec:decay}) %
