...
using the latest configuration of the DUNE ND~\cite{Abi:2020wmh}.
...
consisting of a small LArTPC placed in front of a magnetised high-pressure gaseous TPC~\cite{Abi:2020wmh}.
