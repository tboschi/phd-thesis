...
\begin{figure}
	\centering
	\resizebox{0.9\linewidth}{!}{\input{matrixplot.tex}}
...
\begin{figure}
	\centering
	\resizebox{0.475\linewidth}{!}{\input{nuenorm_E_FHC_sys0.tex}}
	\hfill
	\resizebox{0.475\linewidth}{!}{\input{nuenorm_E_RHC_sys0.tex}}

	\medskip
	\resizebox{0.475\linewidth}{!}{\input{nuenorm_E_FHC_sys1.tex}}
	\hfill
	\resizebox{0.475\linewidth}{!}{\input{nuenorm_E_RHC_sys1.tex}}
...
\begin{figure}
	\centering
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_corr_cont_S23_M23.tex}}	%%%%%%%%%%%this is important
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_anti_cont_S23_M23.tex}}
