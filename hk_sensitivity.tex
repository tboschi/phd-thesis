...
The prediction of the one ring $e$-like samples in $\nu$-mode and $\cj{\nu}$-mode are shown in \reffigs{fig:nue_CC}{fig_nuebar_CC} %
...
\begin{figure}
	\centering
	\resizebox{0.45\linewidth}{!}{\input{nuenorm_E_FHC_sys0.tex}}
	\resizebox{0.45\linewidth}{!}{\input{nuenorm_E_RHC_sys0.tex}}
	\caption{ Left: $\nu_e$ CC -- $\nu$ mode 1R $e$. Right: $\nu_e$ CC -- $\cj{\nu}$ mode 1R $e$}
	\label{fig:nue_CC}
\end{figure}
...
\begin{figure}
	\centering
	\resizebox{0.45\linewidth}{!}{\input{nuenorm_E_FHC_sys1.tex}}
	\resizebox{0.45\linewidth}{!}{\input{nuenorm_E_RHC_sys1.tex}}
...
\begin{figure}
	\centering
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_corr_chi2_dCP.tex}}
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_corr_chi2_M23.tex}}
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_corr_chi2_S13.tex}}
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_corr_chi2_S23.tex}}
	\caption{ Left: $\cj{\nu}_e$ CC -- $\nu$ mode 1R $e$. Right: $\cj{\nu}_e$ CC -- $\cj{\nu}$ mode 1R $e$}
	%\label{fig:nuebar_CC}
\end{figure}
...
\begin{figure}
	\centering
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_corr_cont_dCP_M23.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_corr_cont_S13_dCP.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_corr_cont_S23_dCP.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_corr_cont_S13_M23.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_corr_cont_S23_M23.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_corr_cont_S13_S23.tex}}
	\caption{ Left: $\cj{\nu}_e$ CC -- $\nu$ mode 1R $e$. Right: $\cj{\nu}_e$ CC -- $\cj{\nu}$ mode 1R $e$}
	%\label{fig:nuebar_CC}
\end{figure}
...
\begin{figure}
	\centering
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_anti_chi2_dCP.tex}}
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_anti_chi2_M23.tex}}
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_anti_chi2_S13.tex}}
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_anti_chi2_S23.tex}}
	\caption{ Left: $\cj{\nu}_e$ CC -- $\nu$ mode 1R $e$. Right: $\cj{\nu}_e$ CC -- $\cj{\nu}$ mode 1R $e$}
	%\label{fig:nuebar_CC}
\end{figure}
...
\begin{figure}
	\centering
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_anti_cont_dCP_M23.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_anti_cont_S13_dCP.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_anti_cont_S23_dCP.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_anti_cont_S13_M23.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_anti_cont_S23_M23.tex}}
	\resizebox{0.32\linewidth}{!}{\input{nuenorm_anti_cont_S13_S23.tex}}
	\caption{ Left: $\cj{\nu}_e$ CC -- $\nu$ mode 1R $e$. Right: $\cj{\nu}_e$ CC -- $\cj{\nu}$ mode 1R $e$}
	%\label{fig:nuebar_CC}
\end{figure}
...
\begin{figure}
	\centering
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_corr_sensitivity.tex}}
	\resizebox{0.48\linewidth}{!}{\input{nuenorm_anti_sensitivity.tex}}
	\caption{ Left: $\cj{\nu}_e$ CC -- $\nu$ mode 1R $e$. Right: $\cj{\nu}_e$ CC -- $\cj{\nu}$ mode 1R $e$}
...
\begin{figure}
	\centering
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_chi2_dCP.tex}}
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_cont_dCP_M23.tex}}
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_cont_dCP_M23.tex}}
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_cont_dCP_M23.tex}}
	%

	   \hspace{0.24\linewidth}
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_chi2_M23.tex}}
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_cont_dCP_M23.tex}}
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_cont_dCP_M23.tex}}
	%
	   ...
	   \hspace{0.24\linewidth}
	   \hspace{0.24\linewidth}
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_chi2_S23.tex}}
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_cont_dCP_M23.tex}}
	%
	   ...
	   \hspace{0.24\linewidth}
	   \hspace{0.24\linewidth}
	\resizebox{0.24\linewidth}{!}{\input{nuenorm_corr_chi2_S13.tex}}
	\caption{ Left: $\cj{\nu}_e$ CC -- $\nu$ mode 1R $e$. Right: $\cj{\nu}_e$ CC -- $\cj{\nu}$ mode 1R $e$}
	% \label{fig:nuebar_CC}
\end{figure}
\fi
