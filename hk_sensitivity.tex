...
The details of the oscillation space are listed in \reftab{tab:osc_space}.
...
\section{Sensitivity with the nominal systematic model}
\label{sec:nominal}
...
The neutrinos interactions are generated using NEUT~\cite{Hayato:2003sd}, also used in SK and T3K.
The response of the detector is simulated using the SK-IV full Monte Carlo simulation, which uses the GEANT4 engine~\cite{Brun:1994aa}.
...
Using these predictions and fixing the true oscillation parameter combination to be Asimov A, %
we can now calculate the $\chi^2$ profile with the method explained in the previous sections.
...
The four profiles against the variation of the oscillation parameters are shown in \reffig{fig:nominal_profile}.
...
\begin{figure}
	\centering
	\resizebox{0.48\linewidth}{!}{\input{pics/0_11a_11b_8_chi2_dCP.tex}}
...
\begin{figure}
	\centering
	\resizebox{0.48\linewidth}{!}{\input{pics/0_11a_11b_8_chi2_S13.tex}}
...
\begin{figure}
	\centering
	\resizebox{0.48\linewidth}{!}{\input{pics/0_11a_11b_8_sensitivity.tex}}
