...
The methodology of the sensitivty studies is outlined in \refsec{sec:sensitivity}, %
...
The T2K near detector system, consisting of the detectors ND280 and INGRID~\cite{Abe:2011ks}, will be refurbished %
...
There are a total of \np{2224} bins employed for the atmoshperic sample.
...
the parameters $\bs{\varepsilon}$ are introduced to account for systematic uncertainties by replacing
\begin{equation}
	\label{eq:pull}
...
These two errors are either correlated or anticorrelated %
