...
even to cosmological implications (for a review on sterile neutrinos see e.g.\ \refref{Abazajian:2012ys}).
...
in \emph{beam dump} experiments (see \refsec{cha:beamdump}) and at colliders.
...
Without loss of generality, the mass matrix of \refeq{eq:newmodel} $M_R$ can be chosen to be diagonal.
...
Following \refeq{eq:newmodel} and \refeq{eq:typeI}, the most general mass matrices are then given by 
%
\[
