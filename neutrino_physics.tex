...
Expanding the covariant derivative and ignoring the kinetic terms, the interaction term for the lepton sector is retrieved
\begin{equation}
...
Looking at the lepton sector, the transformations of \refeq{eq:lepton_eigenmass} are not analogously defined for neutrino fields.
...
%$G_A(q^2)$, and $G_P(q^2)$ 
The NCE cross-sections have the same form as the ones in \refeqs{eq:cc_xsec_q}{eq:cc_xsec_t}, %
