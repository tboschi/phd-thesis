...
Applying the same expansion of \refeq{eq:vev_higgs} to the Yukawa terms of the SM lagriangian, %
...
Without diagonal Yukawa couplings, the fermion masses are not defined.
Being a generic complex matrix, the diagonalization can be achived by a biunitary tranformation
\begin{equation} 
	V_L^\dagger Y'_{\alpha \beta} V_R = Y_{\alpha}\ ,
\end{equation} 
