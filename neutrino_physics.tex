...
The angle $\delta_\text{CP}$ is the physical phase. % which is responsible for CP violation.
...
\end{equation}
and its antineutrino counterpart\footnote{In terms of Feynman diagrams, the \emph{t}-channel diagram is %
...
the above processes are described by the effective charged-current and neutral-current Lagrangian
\begin{align}
