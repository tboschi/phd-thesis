...
\begin{table}
	\small
	\centering
	\captionof{table}{Processes occurring in the $pp$ chain (left) and CNO cycle (right) that emits $\nu_e$.
...
\begin{figure}
	...
	\begin{minipage}[t]{0.58\textwidth}
		...
		\captionof{figure}{Prediction of atmospheric neutrinos created with a 3D simulation %
