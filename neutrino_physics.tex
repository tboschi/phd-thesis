...
For neutrino energies above 1\,GeV the cross-section drops as the available $Q^2$ increases; 
At higher energies, inelastic scatterings and processes such as $np-nh$ or resonance productions become relevant.
In this interactions, the nucleon is excited into a baryonic resonance before decaying and emitting %
a charged or a neutral pion.
At high $Q^2$, inelastic scattering is dominated by deep inelastic scattering (DIS), %
as the neutrino has enough energy to scatter directly off a constituent quark, fragmenting the original nucleon.
...
These interactions are referred to as ``shallow inelastic scattering'', %
and there is no clear model for dealing with them.
