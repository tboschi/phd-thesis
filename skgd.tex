...
This value for water is $\xi_{\text{H}_2\text{O}} \simeq 0.93$ in the thermalisation regions, %
where the kinetic energy of the neutron is $2.5\,\text{meV} \lesssim T \lesssim 0.1\,\text{MeV}$.
Neutrons that reach sub-eV energies enter the $1/v$ regions in which the capture probabilities increases as $T^{-1}$.
Hydrogen presents a relative high cross-section for neutron capture, as it can be seen from~\reffig{fig:}: %
the cross-section for a thermal neutron on hydrogen is measured to be $\np{332.6}$~\,mb~\cite{ZERKIN201831}. %
The hydrogen capture is followed by the emission of a $\np{2.2}$\,MeV gammas from the deexctiation of the newly-formed deuterium.
The thermalisation process in water has a characteristic time of $\sim200$\,\textmu s.
that after the production of the neutron 
