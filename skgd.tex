...
In this chapter, the working principle of a generic Cherenkov detector is reviewed in \refsec{sec:wch}, %
before illustrating in more detail the Super-Kamiokande experiment (\refsec{sec:sk}).
The importance for neutron tagging is justified in \refsec{sec:sk_neutron} %
and the benefits and challenges of gadolinium-doping are discussed in \refsec{sec:gadolinium} and in \refsec{sec:gad}.
...
contamination which is usually less than 3\,mBq/m\tapi{3}.
...
\begin{figure}
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\captionof{figure}{Distributions showing PMT quantum efficiency (red), the scintillator yield (blue), %
...
\begin{figure}
	...
	\begin{minipage}[t]{0.54\textwidth}
		...
		\captionof{figure}{The inverse linear fit (red) between concentration and absorption is shown together with data (blue) %
			on the top panel. The absolute values of the errors are roughly constant with the concentration, %
