...
In the calibration analysis, the neutron capture vertex is assumed to be roughly at the same location %
of the Am-Be source.
...
summing up for a total energy of 8.2\,Mev.
...
and activity from non-fission events~\cite{HENDRICK_LABRANCHE}.
...
Thus, it is reasonable to assume that the capture on hydrogen occurs in the proximity of the source, %
bringing about an even more accurate calibration.
