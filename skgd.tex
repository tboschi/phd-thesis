...
\begin{figure}
	\centering
	\resizebox{0.5\linewidth}{!}{\input{gdconcentration.tex}}
...
The Gd(NO3)3 is opaque in the UV region of the electromagnetic spectrum, for wavelengths less than 350\,nm, %
...
A new filtration system, called ``band-pass filtration system'', has been devised for EGADS and for later use in SK.
A schematic can be found in \reffig{fig:egads}.
