...
The neutron calibration of the detector is discussed \refsec{sec:neutron_cal}
...
but a preciser particle identification is possible in certain cases, such as in SK which is discussed in \refsec{sec:sk}.
...
Being the average energy of a SF neutrino from \tapi{252}Cf lower than the one from Am-Be, %
...
of the neutron tagging efficiency (see \refsec{sec:neutron_tagging}).
